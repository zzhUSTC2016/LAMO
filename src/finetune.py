...
def train(
    ...
    assert val_set_size % med_num == 0, "val_set_size should be a multiple of med_num"
    ...
    def metrics(preds, labels):
        ...
        for i in range(val_visit_num):
            ...
            recall, precision, f1, jaccard, num_drugs, num_drugs_gt = metrics_per_visit(
